...
export async function transcribeAudio(
  ...
  hintPhrases: string[] = [],
  /**
   * На каких ещё языках игрок мог заговорить — обычно его родной (или все
   * его родные, для полиглота). Не «улучшение качества», а способ вообще
   * узнать, что он ответил не на том языке: без этого списка провайдер
   * обязан выдать текст на целевом языке и о чужой речи промолчит.
   */
  ...
  try {
    return await impl(audio, languageCode, alternativeLanguages, apiKey, hintPhrases, timeoutMs);
  } catch (e) {
