...
///
/// Один и тот же виджет во всех трёх голосовых режимах: в «Голос Vs
/// Голос» и «Общении» соперники слушают голосовые друг друга, в «Голосе»
/// игрок переслушивает свои. Бакет приватный, поэтому ссылка каждый раз
...
class VoiceMessageBubble extends StatefulWidget {
  ...
  /// сообщением ниже, как в «Голосе». Значок на самом пузыре не
