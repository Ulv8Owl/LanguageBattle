...
class AiAvatar extends StatelessWidget {
  ...
  /// Во сколько раз приблизить.
  ///
  /// 1.8 обрезало голову: в кружок влезала только середина морды. При 1.3
  /// голова помещается целиком, а по краям остаётся немного золотого фона —
  /// картинка прозрачная, и открытый край это просто цвет кружка, а не дыра.
  static const double _zoom = 1.3;
}

/// СТАНДАРТНЫЙ РАЗМЕР МАЛЕНЬКОЙ АВАТАРКИ — ОДИН НА ВСЮ ИГРУ.
///
/// Пришёл из ленты боя, где аватарка обязана быть общей у ИИ и у игроков,
/// иначе сообщения выглядят как разговор существ разного роста. Теперь это
/// же число — минимум и стандарт везде: в списке друзей, в рейтинге, в
/// поиске, в обоих чатах, в группе и в подборе. Мелкие аватарки разных
/// размеров читались как разные сущности, а на собранном пиксельном лице
/// в 32 точки не разобрать, кто это.
///
/// Крупнее бывает только там, где аватарка — не подпись к строке, а сам
/// предмет разговора: карточка игрока, итоги матча, шапка профиля.
