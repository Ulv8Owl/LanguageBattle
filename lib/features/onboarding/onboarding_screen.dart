...
///
/// Стартовый рейтинг здесь НЕ ставится: сразу после этого экрана игрок
/// попадает на выбор уровня CEFR и проверку навыка
/// (lib/features/onboarding/level_select_screen.dart), и рейтинг ставит
/// она. До проверки пара живёт с рейтингом по умолчанию (600).
///
