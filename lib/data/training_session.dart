...
/// РАЗМЕРА КОЛОДЫ ЗДЕСЬ БОЛЬШЕ НЕТ. Он выбирался в настройках (10..50) и
/// резал на заходы колоду из ста купленных слов. Колоды не осталось:
/// слова в тренировку отбирает сам игрок из фразы, и сколько их будет,
/// решает он же — отмечая незнакомые.
...
class TrainingSession {
  ...
  /// Слова, которые ещё не закрыты. Заход идёт, пока список непуст.
  final Set<int> _open;
