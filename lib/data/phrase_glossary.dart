/// Пословные переводы фраз — то, из чего делаются флэш-карточки.
///
/// ЗАЧЕМ ОТДЕЛЬНО ОТ ЭЛЕМЕНТОВ. Элемент это кусок смысла («в семь» ↔
/// "at seven"), и подсказке в «Голосе» его хватает. На карточках
...
/// но карточки работают на всех шести уровнях с первого дня, а не
...
class PhraseGlossary {
  ...
  /// запасном варианте, и карточки от этого не останавливаются.
