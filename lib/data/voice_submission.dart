...
class RecordingOutcome {
  ...
  /// Куда ушло ожидание: очередь (загрузка + триггер + старт воркера),
  /// распознавание, судья. Без этих чисел разговор об ускорении —
  /// гадание, поэтому они показываются в отладочной панели.
  Map<String, dynamic>? get timingDebug => _section('timing');
