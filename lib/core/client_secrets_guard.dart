...
const _forbiddenPatterns = [
  ...
  'ASR_',
  'TTS_',
  // Общий ключ Google покрывает сразу три сервиса, поэтому в клиенте он
  // опаснее любого отдельного: утёкший, он открывает и распознавание, и
  // синтез, и модель.
  'GOOGLE_API_KEY',
  'SERVICE_ROLE',
  'SERVICE_KEY',
...
///
/// Ключи модели, распознавания и синтеза речи живут ТОЛЬКО в секретах Edge
/// Function на стороне Supabase и никогда не покидают сервер: приложение
/// вызывает не провайдеров, а свою базу и свои же функции, а к провайдерам
/// ходят уже они. Если такой ключ однажды случайно допишут в `.env`, он молча
